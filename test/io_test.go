...
func TestToCsvString(t *testing.T) {
	...
	verifyParsedTxs := func(txs []*ptf.Tx) {
		...
		rq.Equal(header+"FOO,2016-01-03,2016-01-05,Sell,5,1.600000,0.000000,CAD,,CAD,,a memo\n"+
			"BAR,2016-01-03,2016-01-06,Buy,7,1.700000,1.000000,USD,1.110000,USD,1.110000,a memo 2\n",
			csvOut)
	}
